...
public class EasyCheckBox extends CheckBox {

    public EasyCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
        FontManager.getInstance().applyFont(this, attrs);
    }

    public EasyCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
